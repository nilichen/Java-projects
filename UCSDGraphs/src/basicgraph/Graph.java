...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
	    List<Integer> degrees = new ArrayList<>(0);
	    for (int v = 0; v < numVertices; v++) {
	        Integer newDegrees = getNeighbors(v).size() + getInNeighbors(v).size();
	        degrees.add(newDegrees);
	    }
	...
	public static void main (String[] args) {
        ...
        System.out.println(graphFromFileMatrix.getDistance2(0));
